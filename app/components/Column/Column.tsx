...
const Column = ({ id, todos, index }: Props) => {
    const { searchString, setNewTaskType } = useBoard()
                        ...
                        <Droppable droppableId={index.toString()} type='todo'>
                            {
                                (provided, snapshot) => (
                                    <div
                                        ...
                                        ref={provided.innerRef}
                                        className={`
                                        pb-2 p-2 rounded-2xl shadow-sm
                                    ...
                                    >
                                        ...
                                        <div className='space-y-2'>
                                            {todos.map((todo, index) => {
                                                if (searchString && !todo.title.toLocaleLowerCase().includes(searchString.toLocaleLowerCase())) return null
